	...
	<header>
		<div class="row">
			<div class="col-sm-1">
				...
				<div id="sm-account" class="dropdown float-right d-block d-sm-none">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item linked" href="#" onclick="location.href='/list'">Events</a>
			...
			<div class="col-sm-10">
				<table>
					<tr>
					<td class="align-middle text-center" style="cursor: context-menu;"><h3 class="font-weight-light"> ${headerMessage}</b></h3></td>
					</tr>
				</table>
			</div>
